...
class ResgateForm(FlaskForm):
    telefone = StringField("Seu telefone:")
    nome = StringField("Seu nome:")
    rua = StringField("Rua:", validators=[InputRequired(message='Preencha sua rua')])
    ...
    nome_complementar = StringField("Seu nome: ")
    telefone_complementar = StringField("Telefone: ")
    parentesco = SelectField("Estado: ", choices=[("Parente", "Parente"), ("Mãe/Pai", "Mãe/Pai"), ("Filho", "Filho"), ("Amigo", "Amigo"), ("Voluntário", "Voluntário"), ("Outro", "Outro")], validators=[DataRequired()], default="RS")
